 ...
 * @author cloudsim
 */
//@WebServlet(urlPatterns = {"/UploadTakcyTale"})
public class UploadTakcyTale extends HttpServlet {
        ...
        if (ServletFileUpload.isMultipartContent(request)) {
            ...
            while (it.hasNext()) {
                ...
                if (fileItemTemp.isFormField()) {
                    ...
                    if (fileItemTemp.getFieldName().equals("school_name")) {
                        school_name = fileItemTemp.getString();
                        System.out.println(optionalFileName);
                    }

                    if (fileItemTemp.getFieldName().equals("pincode")) {
                        pincode = fileItemTemp.getString();
                        System.out.println(optionalFileName);
                    }
                ...
                if (filesize > 60.0) {
                    ...
                    if (fileItem.getSize() > 0) {
                        ...
                        try {
                            ...
                            String path = relativePath.trim() + "\\tt\\";
           ...
           // addUserComplaints(String uid,String csno,String ntype,String ndate,String section,String compdesc,String rprtby,String status,String compltme,String compdate,String fname)                
                            ...
                            String stud_name = request.getSession().getAttribute("sname").toString().toUpperCase().trim();
                            ...
                            DB_SERVICE.DOA_Service.addTekytale(sid, stud_name, schoolname, stud_class, stud_pincode, dob, title, sttfile);
                             ArrayList al=DB_SERVICE.DOA_Service.getTeckyTale(sid);
                request.setAttribute("al", al);
              
                 RequestDispatcher dis = request.getRequestDispatcher("TTdetails.jsp");
