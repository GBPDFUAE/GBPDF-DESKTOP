 ...
 * @author Win7
 */
@WebServlet(urlPatterns = {"/Askmydoubts"})
public class Askmydoubts extends HttpServlet {
 ...
 dis.forward(request, response);
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Askmydoubts</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Askmydoubts at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        } finally {
            out.close();
