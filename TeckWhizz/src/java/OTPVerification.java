 ...
 * @author Win7
 */
@WebServlet(urlPatterns = {"/OTPVerification"})
public class OTPVerification extends HttpServlet {
 ...
 dis.forward(request, response);
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet OTPVerification</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet OTPVerification at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        } finally {
            out.close();
