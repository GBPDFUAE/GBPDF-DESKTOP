...
#toolbar{position:fixed; z-index:3; right:10px; top:10px; padding:5px; background:url(lernmore/fs_img_g_bg.png);}
#toolbar img{border:none;}
#img_title{position:fixed; z-index:3; left:10px; top:10px; padding:10px; background:url(lernmore/fs_img_g_bg.png); 
...
#thumbnails_wrapper{z-index:2; position:fixed; bottom:0; width:100%; background:url(lernmore/empty.gif); /* stupid ie needs a background value to understand hover area */}
#outer_container{position:relative; padding:0; width:100%; margin:40px auto;}
#outer_container .thumbScroller{position:relative; overflow:hidden; background:url(lernmore/fs_img_g_bg.png);}
...
.nextImageBtn{right:0; background:#000 url(lernmore/nextImgBtn.png) center center no-repeat;}
.prevImageBtn{background:#000 url(lernmore/prevImgBtn.png) center center no-repeat;}
-->
</style>
<script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.4/jquery.min.js"></script>
<script type="text/javascript" src="lernmore/jquery.easing.1.3.js"></script>
</head>
<body>
        <h3><a class="btn btn-primary-blue " href="index.jsp"><img src="images/hm.png" height="60" width="60" alt="logo"></a></h3>

    <div id="bg"><a href="#" class="nextImageBtn" title="next"></a><a href="#" class="prevImageBtn" title="previous"></a>
        <img src="lernmore/1.jpg"  alt="Do You Know?" title="Do You Know?" id="bgimg" /></div>
<div id="preloader"><img src="lernmore/ajax-loader_dark.gif" width="32" height="32" /></div>
<!--<div id="img_title"></div>-->

<!--<div id="toolbar"><a href="#" title="Maximize" onClick="ImageViewMode('full');return false">
        <img src="lernmore/toolbar_fs_icon.png" width="50" height="50"  /></a></div>-->
...
<div class="thumbScroller">
	<div class="container">
                <%
                             String louser="";
                            try{
        louser="dd";//request.getSession().getAttribute("sname").toString();
       if(louser!=null ||louser.equalsIgnoreCase("")==false){
            ...
            %>
    	<div class="content">
            <div><a href="lernmore/<%=i%>.jpg">
                    <img src="lernmore/<%=i%>.jpg" height="100" width="100" title="Learn More" alt="Do You know?" class="thumb" /></a></div>
        </div>
        <%
                }
                }
...
$(window).load(function() {
	...
	if($defaultViewMode=="full"){
		$toolbar_a.html("<img src='lernmore/toolbar_n_icon.png' width='50' height='50'  />").attr("onClick", "ImageViewMode('normal');return false").attr("title", "Restore");
	} else {
		$toolbar_a.html("<img src='lernmore/toolbar_fs_icon.png' width='50' height='50'  />").attr("onClick", "ImageViewMode('full');return false").attr("title", "Maximize");
	}
