...
th, td {
  ...
  padding: 8px;
       ...
       <script src='https://meet.jit.si/external_api.js'></script>
        ...
        String studentname=request.getAttribute("sname").toString();
        
         if (staffid != null && staffid.equalsIgnoreCase("") == false && staffid.equalsIgnoreCase("no") == false) {%>
 <script>
...
<!--             <div class="container card">
            ...
            <div class="section-header">
                ...
                <h2 class="section-title text-center wow fadeInDown"> Live Class</h2>
                <center> <a href="https://vidconsom.herokuapp.com/U3F7rNnSG" <h3 class="btn btn-primary-pur btn-round-lg" >Connect</h3></a></center>
...
<!--<div class="row">
  ...
  <div class="row">
    ...
    <%
        ...
        ArrayList<ArrayList> contactlist = (ArrayList<ArrayList>) request.getAttribute("fl");
...
<!--     <table>
    ...
    <tr>
      <td><%=(i + 1)%></td>
      <td><a href="https://18.217.120.86:8443/TeckStaffs/ftp/<%=data.get(1).toString()%>"download><%=data.get(1).toString()%></a></td>
...
<center><h3>READY TO JOIN ? NO ONE ELSE IS HERE</h3></center>
<%}%>
        </section>
