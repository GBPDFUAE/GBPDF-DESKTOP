...
.bgimg {
  background-image: url('images/kidslearn/6.png');
  min-height: 100%;
...
<!--                            <div class="col-md-12">-->
             ...
             String msg="";
                ...
                <div style="padding-top: 2%">
                    ...
                    <form class="login" action="OTPVerification" method="post">
 ...
 <div id="OtpInput"   >
            <div class="field-wrapper">
                <div class="form-group phone"style="padding-left: 1%" >
                    ...
                    <input type="text" name="otps" class="letter"
                           pattern="[0-9]*" inputmode="numeric" maxlength="1">
                    <input  type="hidden" value="<%=otp%>" name="gotp"  placeholder="" maxlength="1">
                </div>
            </div>
        </div>
                </div></center>
