    ...
    <header id="header">
        ...
        <section id="f2f" >
            ...
            <div class="section-header">
                ...
                <h2 class="section-title text-center wow fadeInDown"> Booked Class</h2>
...
<%
 ArrayList<ArrayList> ques = (ArrayList<ArrayList>) request.getAttribute("md");
%>
               <div class="row">
  ...
  Object.keys(groups).forEach(function(value, i) {
    ...
    cell.appendChild(
      document.createTextNode(
        'Clssess  ' + table.rows[0].cells[0].textContent +
