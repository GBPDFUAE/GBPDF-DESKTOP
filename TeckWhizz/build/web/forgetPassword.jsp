...
#OtpInput1 .field-wrapper {
    position: relative;

    width: auto;
}
#OtpInput1 .form-group {
    min-width: 420px;
    width: 50%;
    margin: auto auto;
/*    display: flex;*/
...
<!--                            <div class="col-md-12">-->
             ...
             String msg="";
                ...
                <div style="padding-top: 2%">
                    <h4 style="color:black;padding-left: 2%">ENTER&nbsp;&nbsp;REGISTERED&nbsp;MOBILE&nbsp;NUMBER</h4>
