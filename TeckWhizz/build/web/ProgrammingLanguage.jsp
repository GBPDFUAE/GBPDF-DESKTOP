                ...
                <div id="rms-wizard" class="rms-wizard">
                    ...
                    <div class="rms-container">
                        ...
                        <div class="rms-wizard-header">
                            <h2 class="title">Progamming <span>Language </span></h2>
                        </div>
                        <!--Wizard Header Close--> 
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="inpt-form-group"> 
                                                            ...
                                                            <div class="col-md-4 right "> 
                                                                ...
                                                                <label class="rcontainer">Mobile APP
                                                                    <input type="radio" checked="checked" name="selectlang" value="Mobile APP" onclick="getSelectedLanguAge(this.value)" id="selectlang">
                                                             ...
                                                             <div class="col-md-4 right "> 
                                                                ...
                                                                <label class="rcontainer">HTML
                                                                    <input type="radio"  name="selectlang" value="HTML" onclick="getSelectedLanguAge(this.value)" id="selectlang">
                                                                    <span class="checkmark"></span>
                                                                </label>
                                                             ...
                                                             <div class="col-md-4 right "> 
                                                                ...
                                                                <label class="rcontainer">JAVA
                                                                    <input type="radio"  name="selectlang" value="JAVA" onclick="getSelectedLanguAge(this.value)" id="selectlang">
                                                                    <span class="checkmark"></span>
                                                                </label>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="inpt-form-group"> 
                                                            ...
                                                            <div class="col-md-4 right "> 
                                                                ...
                                                                <label class="rcontainer">C Progamming
                                                                    <input type="radio" checked="checked" name="selectlang" value="Mobile APP" onclick="getSelectedLanguAge(this.value)" id="selectlang">
                                                                    <span class="checkmark"></span>
                                                                </label>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-10">
                                                        <div class="inpt-form-group"> 
                                                            ...
                                                            <div class="col-md-3"> 
                                                                <span for="panumberimg"  style="float: right">Age</span> 


                                                            </div>
                                                            <div class="col-md-5"> 

                                                                <input type="Number" name="Age" onblur="getSelectedWS(this.value)"   class="form-input"  value="" required="" />
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="col-md-10">
                                                            <div class="inpt-form-group"> 
                                                                ...
                                                                <div class="col-md-3"> 
                                                                    <span for="panumberimg"  style="float: right">Standard</span> 
                                                                ...
                                                                <div class="col-md-5"> 
                                                                    ...
                                                                    <select name="Standard" class="form-select">
                                                                        ...
                                                                        <option value="XII & ABOVE" >XII & ABOVE</option>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="inpt-form-group"> 
                                                            ...
                                                            <div class="col-md-4 right "> 
                                                                ...
                                                                <label class="rcontainer">BASIC
                                                                    <input type="radio" name="bi"  Checked="" onclick="getSelectedDesign(this.value)"  id="design" value="BASIC"/>
                                                                    <span class="checkmark"></span>
                                                                </label>
                                                              ...
                                                              <div class="col-md-4 right "> 
                                                               ...
                                                               <div class="col-md-4 right "> 
                                                                ...
                                                                <label class="rcontainer">ADVANCED
                                                                    <input type="radio" name="bi"  onclick="getSelectedDesign(this.value)"  id="design" value="ADVANCED"/>
                                                                    <span class="checkmark"></span>
                                                                </label>
...
//                                                    }
                                                ...
                                                {
                                                    if(val>=10){
                                                    document.getElementById("ageselecttitle").innerHTML ="AGE :"+ val;
                                                }else
                                                {
