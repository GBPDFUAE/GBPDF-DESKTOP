                ...
                <div class="content">
                       ...
                       <%
                                                        try{
                                                            ...
                                                            {%>
                                                            <script>alert('shared successfully');</script> 
                                                            <%}
   ...
   <div class="card-body">
    <form method="post" class="form-group" action="uploadServlet"
     ...
     <div class="form-group">
         <label for="first name">Share To: </label> 
         <select  class="form-control" name="stud"  >
             <option value="all">All</option>
                <%
                  ...
                  %>                                  
                  <option value="<%=sl.get(j) %>"><%=sl.get(j) %></option>
             <%
                                                                    }
             %>
         </select>
...
<!--     <div class="form-group">
     ...
     <div class="form-group">
      <label for="Profile Photo">Attach File:</label> <input
          type="file" name="myfile" class="form-control-file" size="50" />
     </div>
