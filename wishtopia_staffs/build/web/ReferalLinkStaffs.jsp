            ...
            <div class="page-wrapper">
                <div class="content">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card-box">
                                <h4 class="card-title"> Referal Staff Link</h4>
                                                     ...
                                                     <div class="col-sm-12">
                                                           <div class="form-group"> 
                                                                        <label for="state"> Subjects</label>
                                                                            ...
                                                                            <select  name="subjects" id="subjects" class="form-control select2-container--default" onchange="CheckSubOthers(this.value);">
                                            ...
                                            <table class="datatable table table-stripped ">
                                                ...
                                                <tbody>
                                                 ...
                                                 <td>1</td>
                                                        ...
                                                        <td>9876543210</td>                                                        
                                                        <td><a class="btn badge-danger-border">InActive</a></td>
                                                        <td><a href="#">WZTR0123</a></td>
                                                     </tr>
                                                </tbody>
