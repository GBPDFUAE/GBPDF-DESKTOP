...
<html lang="en">
    ...
    String ssid=request.getAttribute("ssid").toString();
    %>
                    ...
                    <div id="rms-wizard" class="rms-wizard">
                        ...
                        <div class="rms-container">
                            ...
                            <div class="rms-wizard-header">
                                <h2 class="title">Edit Onboarding  <span>Form </span></h2>
                            </div>
                            <!--Wizard Header Close--> 
                            <form method="post" action="UpdateProfile" id="frm" enctype="multipart/form-data">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="inpt-form-group"> 
                                                                        ...
                                                                        <div class="inpt-group">
                                                                            ...
                                                                            <input type="text" name="firstname" id="firstname" class="inpt-control" value="<%= Profile_data.get(1).toString()%>"  required="" placeholder="First Name">
                                                                            <input type="hidden" name="ssid" id="ssid" class="inpt-control" value="<%=ssid %>"  required="" placeholder="First Name">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="inpt-form-group"> 
                                                                        ...
                                                                        <div class="inpt-group">
                                                                            <input type="text" name="lastname" id="lastname"  class="inpt-control" required="" value="<%= Profile_data.get(2).toString()%>" placeholder="Last name">
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="inpt-form-group"> 
                                                                        ...
                                                                        <div class="inpt-group"> 
                                                                            ...
                                                                            <input type="text" name="email" id="email" class="inpt-control" required="" value="<%= Profile_data.get(3).toString()%>" placeholder="Please Enter your mail ID">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="inpt-form-group"> 
                                                                        ...
                                                                        <div class="inpt-group"> 
                                                                            ...
                                                                            <input type="text" name="phone" id="phone" class="inpt-control" value="<%= Profile_data.get(4).toString()%>" placeholder="Please Enter your Phone Number">
                                                                    ...
                                                                    <div class="inpt-form-group"> 
                                                                        ...
                                                                        <div class="inpt-group dropdown-select-icon"> 
                                                                            <select name="gender" id="gender" class="inpt-control">
                                                                                <option selected="" value="<%= Profile_data.get(5).toString()%>"><%= Profile_data.get(5).toString()%></option>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-4">
                                                                    <div class="inpt-form-group"> 
                                                                        ...
                                                                        <div class="inpt-group">  
                                                                            <input type="date" name="dob" id="dob" value="<%= Profile_data.get(6).toString()%>" class="inpt-control" placeholder="Date of Birth"> 
                                                                        </div>
                                                                    ...
                                                                    <div class="inpt-form-group"> 
                                                                        ...
                                                                        <div class="inpt-group dropdown-select-icon"> 
                                                                            <select name="subjects" id="subjects" class="inpt-control" onchange="CheckSubOthers(this.value);">
                                                                                <option selected="" value="<%= Profile_data.get(7).toString()%>"><%= Profile_data.get(7).toString()%></option>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <div class="inpt-form-group"> 
                                                                        ...
                                                                        <div class="inpt-group">  
                                                                            <input type="text" name="address" id="address" value="<%= Profile_data.get(8).toString()%>"  class="inpt-control" placeholder="Please Enter your Home Address">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="inpt-form-group"> 
                                                                        ...
                                                                        <div class="inpt-group"> 
                                                                            ...
                                                                            <input type="text" name="fathername"  id="fathername" class="inpt-control" required="" value="<%= Profile_data.get(9).toString()%>" placeholder="Please Enter Father's Name">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="inpt-form-group"> 
                                                                        ...
                                                                        <div class="inpt-group"> 
                                                                            ...
                                                                            <input type="number" name="alternatecon_num"  id="alternatecon_num" class="inpt-control " value="<%= Profile_data.get(10).toString()%>" required="" placeholder="Please Enter Contact Number">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="inpt-form-group"> 
                                                                        ...
                                                                        <div class="inpt-group"> 
                                                                            ...
                                                                            <input type="text" name="panumber"  id="panumber" class="inpt-control" value="<%= Profile_data.get(11).toString()%>" required placeholder="Please Enter Pan Number">
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="inpt-form-group"> 
                                                                        ...
                                                                        <div class="inpt-group"> 
                                                                            ...
                                                                            <input type="text" name="aadhar"  id="aadhar" class="inpt-control required" value="<%= Profile_data.get(13).toString()%>" placeholder="Please Enter Aadhar Number">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <div class="inpt-form-group"> 
                                                                        ...
                                                                        <div class="inpt-group"> 
                                                                            <span class="inpt-group-addon"><i class="fa fa-phone fa-rotate-270" aria-hidden="true"></i></span>
                                                                            <input type="text" name="hobbies" id="hobbies" class="inpt-control required" value="<%= Profile_data.get(16).toString()%>" placeholder="Please Enter your Hobbies or Interests">
                                                    ...
                                                    ArrayList data = school.get(j);%>
                                                                            <tr>  
                                                                                <td class="col-md-3">  
                                                                                    ...
                                                                                    <div class="inpt-form-group"> 
                                                                                        ...
                                                                                        <div class="inpt-group">  
                                                                                            <input type="text" name="wrkschool" id="wrkschool" value="<%=data.get(2).toString() %>" class="inpt-control required" placeholder="School Name"> 
                                                                                ...
                                                                                <td class="col-md-3">  
                                                                                    ...
                                                                                    <div class="inpt-form-group"> 
                                                                                        ...
                                                                                        <div class="inpt-group">  
                                                                                            <input type="text" name="wrkexp" id="wrkexp" value="<%=data.get(3).toString() %>" class="inpt-control required" placeholder="eg:1.3 means 1 yr 3 months"> 
                                                                                    ...
                                                                                    <div class="inpt-form-group"> 
                                                                                        ...
                                                                                        <div class="inpt-group">  
                                                                                            <Select   class="inpt-control" name="brd"id="brd">
                                                                                                <option value="select" selected=""><%=data.get(4).toString() %> </option>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <div class="table-responsive">  
                                                                        <table class="table table-bordered" id="dynamic_field1" style="display: none">  
                                                                 ...
                                                                 int k=0;
                                                                    ...
                                                                    for (int j = 0; j < tution.size(); j++) {
                                                                        
                                                    ArrayList data = tution.get(j);
                                                                            ...
                                                                            <tr>  
                                                                                <td class="col-md-3">  
                                                                                    ...
                                                                                    <div class="inpt-form-group"> 
                                                                                        ...
                                                                                        <div class="inpt-group">  
                                                                                            <input type="text" name="subject" id="subject" value="<%=data.get(2).toString()%>" class="inpt-control required addsub" placeholder="Subject Name"> 
                                                                                    ...
                                                                                    <div class="inpt-form-group"> 
                                                                                        ...
                                                                                        <div class="inpt-group " > 
                                                                                            <div class="form-control" style="overflow: auto; overflow-y: auto;height: 40px;">
                                                                                                <input type="checkbox" class="std"   name="std" value="Nursery">Nursery</br>
                                                                                                <input type="checkbox" class="std"  name="std" value="Juniorkg">Junior KG</br>
                                                                                                <input type="checkbox" class="std" name="std" value="Seniorkg">Senior KG</br>

                                                                                                <%
                                                                                                    for (int i = 1; i <= 12; i++) {
                                                                                                %>
<!--                                                                                                <option value="<%=i%>"><%=i%></option>-->
                                                                                                <input type="checkbox"  class="std" name="std" value="<%=i%>"><%=i%></br>
                                                                                                <%
                                                                                                    }
                                                                                                %>
                                                                                                <!--                                                                                            </select>-->
                                                                                ...
                                                                                <td class="col-md-3">  
                                                                                    ...
                                                                                    <div class="inpt-form-group"> 
                                                                                        ...
                                                                                        <div class="inpt-group">  
                                                                                            ...
                                                                                            <input type="time" name="sttme" id="srttime" value="<%=data.get(3).toString() %>" class="inpt-control addst"/>
                                                                                ...
                                                                                <td class="col-md-3">  
                                                                                    ...
                                                                                    <div class="inpt-form-group"> 
                                                                                        ...
                                                                                        <div class="inpt-group">  
                                                                                            <input type="time" name="endtime" id="endtime" value="<%=data.get(4).toString() %>" class="inpt-control required addend" > 
                                                                                        </div>
                                                                            ...
                                                                            <tr>  
                                                                                <td class="col-md-6">  
                                                                                    ...
                                                                                    <div class="inpt-form-group"> 
                                                                                        ...
                                                                                        <div class="inpt-group">  
                                                                                            <input type="text" name="instution" id="instution" value="<%=data.get(2).toString() %>" class="inpt-control required" placeholder="Instution Name"> 
                                                                                        </div>
                                                                                    </div>
                                                                                ...
                                                                                <td class="col-md-3">  
                                                                                    ...
                                                                                    <div class="inpt-form-group"> 
                                                                                        ...
                                                                                        <div class="inpt-group">  
                                                                                            <input type="text" name="degree" id="degree" value="<%=data.get(3).toString() %>" class="inpt-control required" placeholder="MSC,MED"> 
                                                                                        </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="inpt-form-group"> 
                                                                        ...
                                                                        <div class="inpt-group">
                                                                            <input type="text" name="bankname" id="bankname" value="<%=Profile_data.get(17).toString()%>" class="inpt-control " required="" placeholder="Bank Name">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="inpt-form-group"> 
                                                                        ...
                                                                        <div class="inpt-group">
                                                                            <input type="text" name="ifsc" id="ifsc" class="inpt-control" required="" value="<%=Profile_data.get(18).toString()%>" placeholder="IFSC CODE">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="inpt-form-group"> 
                                                                        ...
                                                                        <div class="inpt-group">
                                                                            <input type="text" name="micr" id="bankname" value="<%=Profile_data.get(19).toString()%>" class="inpt-control" required placeholder="MICR CODE">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <div class="inpt-form-group"> 
                                                                        ...
                                                                        <div class="inpt-group">
                                                                            <input type="text" name="bank_address" value="<%=Profile_data.get(21).toString()%>" id="bank_address" class="inpt-control "  required placeholder="Name as Per Bank Record">
...
//                                                    });
        ...
        <script>
            $(document).ready(function() {
                ...
                $('#add').click(function() {
                    i++;
                    $('#dynamic_field').append('<tr id="row' + i + '"><td class="col-md-3">\n\
   ...
   <div class="inpt-form-group"><label for="wrkschool">&nbsp;</label><div class="inpt-group"><button type="button" name="remove" id="' + i + '" class="inpt-control btn_remove">X</button></div></div></td>\n\
                ...
                $('#add1').click(function() {
                    i++;
                    $('#dynamic_field1').append('<tr id="srow' + i + '"><td class="col-md-2">\n\
     <div class="inpt-form-group"><label for="wrkschool"> Subject Name</label><div class="inpt-group "><input type="text" name="subject" id="subject" class="inpt-control  addsub" placeholder="Subject Name"></div></div>\n\
   </td> <td class="col-md-3"> <div class="inpt-form-group"> <label for="std">Standard</label><div class="inpt-group " > <div class="form-control" style="overflow: auto; overflow-y: auto;height: 40px;"><input type="checkbox" class="std"   name="std" value="Nursery">Nursery</br><input type="checkbox" class="std"  name="std" value="Juniorkg">Junior KG</br><input type="checkbox" class="std" name="std" value="Seniorkg">Senior KG</br><%for (int i = 1; i <= 12; i++) {%><input type="checkbox" class="std"   name="std" value="<%=i%>"><%=i%></br><%}%></div><span class="error_show" id="esubject">Standard is required</span> </div></div></td><td class="col-md-3">\n\
   <div class="inpt-form-group"><label for="wrkschool"> Start Time</label><div class="inpt-group"><input type="time" name="sttme" id="sttme" class="inpt-control  addst" placeholder="Experience"></div></div>\n\
   </td> \n\
   <td class="col-md-3">\n\
   <div class="inpt-form-group"><label for="wrkschool"> End Time</label><div class="inpt-group"><input type="time" name="endtime" id="endtime" class="inpt-control required addend" placeholder="Experience"></div></div>\n\
   </td>\n\
   <td class="col-md-1">\n\
