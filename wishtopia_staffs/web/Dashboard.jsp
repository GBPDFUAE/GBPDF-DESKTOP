...
.hiddenRow {
  display: none;
    ...
    <%
        ...
        String staff_id = request.getAttribute("staffid").toString();
    %>
    <%
        try {
                ...
                <ul class="nav user-menu float-right">
                    ...
                    <li class="nav-item dropdown has-arrow">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a class="dropdown-item" href="#" data-toggle="modal" data-delete="<%=staff_id%>" data-target="#change_pwd"> Change&nbsp;Password</a>
                        ...
                        <div class="col-md-6 col-sm-6 col-lg-6 col-xl-4">
                            <div class="dash-widget">
                                ...
                                <div class="dash-widget-info text-right">
                                    <h3>0</h3>
                                    <span class="widget-title1">No.of&nbsp;Hours&nbsp;taken <i class="fa fa-check" aria-hidden="true"></i></span>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-6 col-lg-6 col-xl-4">
                            <div class="dash-widget">
                                <span class="dash-widget-bg2"><i class="fa fa-laptop"></i></span>
                                <div class="dash-widget-info text-right">
                                    <h3>0</h3>
                                    <span class="widget-title2">No&nbsp;of&nbsp;videos&nbsp;uploaded <i class="fa fa-check" aria-hidden="true"></i></span>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-6 col-lg-6 col-xl-4">
                            <div class="dash-widget">
                                <span class="dash-widget-bg3"><i class="fa fa-video-camera" aria-hidden="true"></i></span>
                                <div class="dash-widget-info text-right">
                                    <h3>0</h3>
                                    <span class="widget-title3"> No&nbsp;of&nbsp;test&nbsp;given <i class="fa fa-check" aria-hidden="true"></i></span>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-6 col-lg-6 col-xl-4">
                            <div class="dash-widget">
                                ...
                                <div class="dash-widget-info text-right">
                                    <h3>0</h3>
                                    <span class="widget-title4">No&nbsp;of&nbsp;questions&nbsp;added <i class="fa fa-check" aria-hidden="true"></i></span>
                                </div>
                            </div>
                        </div>
                    </div>
