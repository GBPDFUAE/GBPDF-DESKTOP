...
public class Forgetpasword extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            boolean res=DOA_Services.checkStaffMobile(mobno);
            
            if(res)
            {
             String otp=   DOA_Services.getOTP();
             
              String msg="Welcome to WISHTOPIA LEARNINGS,To Register your One Time Password(OTP) for Verification-Enter OTP :"+otp;
