 ...
 * @author Win7
 */
@WebServlet(urlPatterns = {"/CompleteProfile"})
            ...
            while (it.hasNext()) {
                ...
                if (fileItemTemp.isFormField()) {
                    ...
                    if (fileItemTemp.getFieldName().equals("panumber")) {
                     ...
                     if (fileItemTemp.getFieldName().equals("tcc")) {
                        llo = fileItemTemp.getString();

                    }
                     
                      if (fileItemTemp.getFieldName().equals("ll")) {
                        ll = fileItemTemp.getString();
                    ...
                    if (fileItemTemp.getFieldName().equals("hobbies")) {
                     ...
                     if (fileItemTemp.getFieldName().equals("abt")) {
                        aboutme = fileItemTemp.getString();
...
//                        }
                ...
                DOA_Services.addStaffProfile(first_name, last_name, email, phone, gender, dob, subject, address, fathers_name, alternatecon_num, pan_num, panimg, adhar_num, adhar_frnt_img, adhar_bck_img, happies, bankname, ifsc, mirc, bnkimg, bankaddres,aboutme,llo,ll);
                ...
                out.println("<script>alert('Thank You, Records Added Succesfully')</script>");
                 ...
                 out.println("<script>window.location.href = 'https://www.wishtopia.in/';</script>");
