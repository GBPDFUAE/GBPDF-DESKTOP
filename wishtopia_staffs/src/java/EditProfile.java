    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            /* TODO output your page here. You may use following sample code. */
             ...
             String staffid=request.getParameter("sid").toString();
           ArrayList personal = DOA_Services.getStaffListbyID(staffid);
            ...
            request.setAttribute("school", school);
             request.setAttribute("ssid", staffid);
            RequestDispatcher dis = request.getRequestDispatcher("EditStaffProfile.jsp");
