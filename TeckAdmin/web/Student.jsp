...
<!--                                            <th>Blocking&nbsp;Status</th>
                                    ...
                                    <tbody>
                                        ...
                                        <%
                                            ArrayList<ArrayList> studlist = (ArrayList<ArrayList>) request.getAttribute("studlist");
                                            int sz = studlist.size();
                                            if (sz > 0) {
                                                for (int i = 0; i < sz; i++) {
                                                    ArrayList data = studlist.get(i);
                                                    String sid = data.get(0).toString();
                                                    String sname = data.get(1).toString();
                                                    String smno = data.get(2).toString();
                                                    String spincode = data.get(3).toString();
                                                    String scls = data.get(4).toString();
                                                    String semail = data.get(5).toString();
                                                    String sparents = data.get(6).toString();
                                                    String school = data.get(7).toString();
                                                    String bl = data.get(9).toString();
                                                    String dl = data.get(10).toString();
                                        %>	
                                        ...
                                        <tr>
                                            ...
                                            <td><%=(i + 1)%></td>
                                            <td><%=sname%></td>
                                            <td><a href="tel://<%=smno%>"><%=smno%></a> </td>
                                            <td><%=spincode%></td>
                                            <td><%=scls%></td>
                                            
                                            <td><%=sparents%></td>
                                            <td><%=school%></td>
                                            <td><a href="email://<%=smno%>"><%=semail%></a></td>
...
<!--                                                                                                    <a class="dropdown-item" href="StaffEdit?sid=<%=data.get(0) %>"><i class="fa fa-pencil m-r-5"></i> Edit</a>-->
													...
													<a class="dropdown-item" href="#" data-toggle="modal" data-delete="<%=data.get(0) %>" data-target="#delete_student"><i class="fa fa-trash-o m-r-5"></i> Delete</a>
												</div>
											</div>
										</td>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                $("#del").click(function() {
                    ...
                    window.location.href = "DeleteStudent?stuid=" + y;
