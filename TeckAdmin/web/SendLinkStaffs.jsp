                ...
                <div class="content">
                    <div class="row">
                        <div class="col-sm-4 col-3">
                            <h4 class="page-title">Send Staff send link list </h4>
                        </div>
                        <div class="col-sm-8 col-9 text-right m-b-20">
                            <a href="AddStaffSendLink.jsp" class="btn btn btn-primary btn-rounded float-right"><i class="fa fa-user-plus"></i> Send Staff Links</a>
                        </div>    
                            ...
                            <div class="table-responsive">
                                <table id="myTable" class="table table-border table-striped custom-table datatable mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <%
                                            ArrayList<ArrayList> contactlist = (ArrayList<ArrayList>) request.getAttribute("sndlkns");
                                            ...
                                            if (sz > 0) {
                                                for (int i = 0; i < sz; i++) {
                                                    ...
                                                    String message = data.get(3).toString();
                                                    String about = data.get(4).toString();
                                                    String personal = data.get(5).toString();
                                                    String educational = data.get(6).toString();
                                                    String bank = data.get(7).toString();
                                                     String dt = data.get(8).toString();
...
<!--											<div class="dropdown dropdown-action">
    	...
    	<a class="btn btn-danger btn-rounded" href="#" data-toggle="modal" data-delete="<%=data.get(0) %>" data-target="#delete_staff">&nbsp;&nbsp;Delete&nbsp;</a>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                $("#del").click(function() {
                    ...
                    window.location.href = "DeleteStafflink?stdid=" + y;
