                ...
                <div class="content">
                    <div class="row">
                        <div class="col-sm-4 col-3">
                            <h4 class="page-title">Become a Teacher List</h4>
                        </div>
                            ...
                            <div class="table-responsive">
                                <table id="myTable" class="table table-border table-striped custom-table datatable mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <%
                                            ArrayList<ArrayList> beacomeslst = (ArrayList<ArrayList>) request.getAttribute("bteacetlist");
                                            int sz = beacomeslst.size();
                                            if (sz > 0) {
                                                for (int i = 0; i < sz; i++) {
                                                    ArrayList data = beacomeslst.get(i);
                                                    String sid = data.get(0).toString();
                                                    String fullname = data.get(1).toString();
                                                    String smno = data.get(2).toString();
                                                    String gender = data.get(3).toString();
                                                    String subject_export = data.get(4).toString();
                                                    String email = data.get(5).toString();
                                                    String dob = data.get(6).toString();
                                                    String martial_status = data.get(7).toString();
                                                    String referal_code = data.get(8).toString();
                                                    String degree = data.get(9).toString();
                                                     String pincode = data.get(10).toString();
                                        %>	
