                ...
                <div class="content">
                    <div class="row">
                        <div class="col-sm-4 col-3">
                            <h4 class="page-title"> Career From Website</h4>
                        </div>
...
<!--                                            <th class="text-right">Action</th>-->
                                    ...
                                    <tbody>
                                        ...
                                        <%
                                            ArrayList<ArrayList> contactlist = (ArrayList<ArrayList>) request.getAttribute("careers");
                                            int sz = contactlist.size();
                                            if (sz > 0) {
                                                for (int i = 0; i < sz; i++) {
                                                    ArrayList data = contactlist.get(i);
                                                    String sid = data.get(0).toString();
                                                    String stud_name = data.get(1).toString();
                                                    String parent_name = data.get(2).toString();
                                                    String email = data.get(3).toString();
                                                    String mobno = data.get(4).toString();
                                                    String message = data.get(5).toString();
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="tel://<%=mobno%>"><%=mobno%></a> </td>
                                           
                                               <td><a href="https://18.188.48.30:8443/wishtopia/careers/<%=message%>" download ><%=message%></a></td>
