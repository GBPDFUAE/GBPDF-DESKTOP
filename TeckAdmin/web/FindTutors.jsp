                            ...
                            <div class="table-responsive">
                                <table id="myTable" class="table table-border table-striped custom-table datatable mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <%
                                            ArrayList<ArrayList> contactlist = (ArrayList<ArrayList>) request.getAttribute("tutors");
...
<a class="dropdown-item" href="EditFindTutor?fid=<%=data.get(0)%>"><i class="fa fa-pencil m-r-5"></i> Edit</a>
                                                        <a class="dropdown-item" href="#" data-toggle="modal" data-delete="<%=data.get(0)%>" data-target="#delete_tutor"><i class="fa fa-trash-o m-r-5"></i> Delete</a>
                                                    </div>
                                                </div>
                                            </td>
            ...
            <div id="delete_tutor" class="modal fade delete-modal" role="dialog">
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                $('#delete_tutor').on('show.bs.modal', function(e) {
                ...
                $("#del").click(function() {
                    ...
                    window.location.href = "DeleteTutor?tid=" + y;
