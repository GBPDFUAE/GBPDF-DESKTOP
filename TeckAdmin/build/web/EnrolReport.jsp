...
<html lang="en">
                ...
                <div class="content">
                    <div class="row">
                        <div class="col-sm-4 col-3">
                            <h4 class="page-title">Enroll Report </h4>
                        </div>
  ...
  <div class="col-lg-8 offset-lg-2">
                                                <form action="AddEnrollReport" method="post">
                                                     <div class="row">
                                                    <div class="col-sm-12">
                           ...
                           <div class="row">
                                                    ...
                                                    <h2>Enroll Tuition Report List</h2>
...
<tr style="background-color: red;color: white">
 ...
 <a class="dropdown-item" href="EditEnrollReport?cid=<%=data.get(0)%>"><i class="fa fa-pencil m-r-5"></i> Edit</a>
        ...
        $("#exceldwn").click(function() {
            ...
            $("#table2excel").table2excel({
                ...
                $("#del").click(function() {
                    ...
                    window.location.href = "DeleteEnrollReport?dptid=" + y;
