...
//     ArrayList<ArrayList> personal = (ArrayList<ArrayList>) request.getAttribute("personal");
        ...
        <div class="main-wrapper">
            <div class="header">
                <div class="header-left">
                    <a href="#" class="logo">
                        <img src="assets/img/user.jpg" width="35" height="35" alt=""> <span>Wishtopia</span>
                    </a>
                </div>
                                                    ...
                                                    <li>
                                                        ...
                                                        <div class="experience-content">
                                                            <div class="timeline-content">
                                                                ...
                                                                <a href="#"><img width="70" height="50" src="http://18.217.120.86:8080/wishtopia/adhar/<%=Profile_data.get(14).toString() %>" alt=""></a>
                                                                <a href="http://18.217.120.86:8080/wishtopia/adhar/<%=Profile_data.get(14).toString() %>" download>Download</a>
