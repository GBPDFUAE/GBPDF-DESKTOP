                ...
                <div class="content">
                    <div class="row">
                        <div class="col-sm-4 col-3">
                            <h4 class="page-title"> Enroll Tuition From Website</h4>
                        </div>
                                    ...
                                    <tbody>
                                        ...
                                        <%
                                            ...
                                            if (sz > 0) {
                                                for (int i = 0; i < sz; i++) {
                                                    ...
                                                    String mobno = data.get(3).toString();
                                        ...
                                        <tr>
                                           ...
                                           <td><%=data.get(2).toString()%> </td>
                                            <td><a href="EnrolReport?mno=<%=mobno%>"><%=mobno%></a> </td>
                                            ...
                                            <td><%=data.get(6).toString()%> </td>
                                             <td><%=data.get(7).toString()%> </td>
                                              ...
                                              <td><%=data.get(9).toString()%> </td>
                                              <td><%=data.get(10).toString()%> </td>
