                        ...
                        <div class="col-md-6 col-sm-6 col-lg-6 col-xl-4">
                            <div class="dash-widget">
                                ...
                                <div class="dash-widget-info text-right">
                                    <h3>100000</h3>
                                    <span class="widget-title1">Total&nbsp;Tution&nbsp;Revenue <i class="fa fa-check" aria-hidden="true"></i></span>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-6 col-lg-6 col-xl-4">
                            <div class="dash-widget">
                                ...
                                <div class="dash-widget-info text-right">
                                   <h3>50000</h3>
                                    <span class="widget-title2">Total&nbsp;Crash&nbsp;Cource&nbsp;Revenue <i class="fa fa-check" aria-hidden="true"></i></span>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-6 col-lg-6 col-xl-4">
                            <div class="dash-widget">
                                ...
                                <div class="dash-widget-info text-right">
                                   <h3>50000</h3>
                                    <span class="widget-title3"> Total&nbsp;Language&nbsp;Learning <i class="fa fa-check" aria-hidden="true"></i></span>
                                </div>
                            </div>
                        </div>
