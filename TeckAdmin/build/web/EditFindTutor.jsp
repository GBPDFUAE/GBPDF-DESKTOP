...
<html lang="en">
                ...
                <div class="content">
                    <div class="row">
                        <div class="col-sm-4 col-3">
                            <h4 class="page-title"> Add Staff send to email link </h4>
                        </div>
  ...
  <div class="col-lg-8 offset-lg-2">
                                                <form action="AddSendStaffLink" method="post">
                                                     <div class="row">
                                                    <div class="col-sm-12">
                                                        <div class="form-group">
                                                            <label>Email(more Email separete by(,) comma)</label>
                                                            <input class="form-control" type="text" name="emails">
                                                        </div>
                                                    </div>
                                                     </div>
                                                     <div class="row">
                                                      <div class="col-sm-12">
                                                        <div class="form-group">
                                                            <label>Mobile number(more Mobile number separete by(,) comma)</label>
