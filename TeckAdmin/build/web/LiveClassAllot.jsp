...
<!--						<a class="dropdown-item" href="profile.html">My Profile</a>-->
            ...
            <div class="page-wrapper">
                <div class="content">
                     <form action="AddMapping" method="post">
...
j=j+(i+1);
                            ...
                            <input type="date" autofocus="" name="fdate" class="form-control">
                        </div>
                                       </div>
                                        ...
                                        <div class="col-md-6">
                                         <div class="form-group">
                            <label>To date</label>
                            <input type="date" autofocus="" name="tdate" class="form-control">
                        </div>
                                       </div>
                                   </div>
                                        <div class="row">
                            ...
                            <input type="time" autofocus="" name="ftime" class="form-control">
                        </div>
                                             </div>
                                             <div class="col-md-6">
                                       <div class="form-group">
                            <label> To Time</label>
                            <input type="time" autofocus="" name="totime" class="form-control">
                        </div>
                                             </div>
                                   </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                     <div class="m-t-20 text-center">
                                                        <button class="btn btn-primary submit-btn">Map Video Class</button>
                                                    </div>
                                                    </div>
...
<%
 ...
 <a class="dropdown-item" href="VideoMapEdit?sid=<%=data.get(0)%>"><i class="fa fa-pencil m-r-5"></i> Edit</a>
                                                        <a class="dropdown-item" href="#" data-toggle="modal" data-delete="<%=data.get(0)%>" data-target="#delete_videomap"><i class="fa fa-trash-o m-r-5"></i> Delete</a>
                                                    </div>
                                                </div>
                                            </td>
                                                     </tr>
