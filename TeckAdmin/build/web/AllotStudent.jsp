...
<!--						<a class="dropdown-item" href="profile.html">My Profile</a>-->
            ...
            for (int i = 0; i < staffs.size(); i++) {
                                                           ArrayList sl =staffs.get(i); 
                                                                    
                  %>                                  
                  
                   <input type="checkbox" class="staffid" name="staffid" value="<%=sl.get(0) %>"><%=sl.get(1)+" "+sl.get(2) %></br>
             <%
                                                                    }
             %>
                                                          </div>
...
j=j+(i+1);
                                                    %>
                                                     ...
                                                     <td><input type="checkbox" value="<%=data.get(0).toString()%>" name="stuid"/> </td>
...
<script type="text/javascript" src="assets/js/csl.js"></script>
    ...
    var checkbox = document.getElementsByName('staffid');
