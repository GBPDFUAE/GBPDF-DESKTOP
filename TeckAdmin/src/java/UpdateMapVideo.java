 ...
 * @author Win7
 */
@WebServlet(urlPatterns = {"/UpdateMapVideo"})
public class UpdateMapVideo extends HttpServlet {
 ...
 DOA_Services.DeleteVideoMap(mid);
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet UpdateMapVideo</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet UpdateMapVideo at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        } finally {
            out.close();
