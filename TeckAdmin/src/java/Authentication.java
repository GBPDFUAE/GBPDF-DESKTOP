...
public class Authentication extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if ((uname.equals("wishtopia") && pwd.equalsIgnoreCase("Mohanraj10@"))|| (uname.equals("admin") && pwd.equalsIgnoreCase("admin"))) {
                RequestDispatcher dis = request.getRequestDispatcher("DashBaord");
