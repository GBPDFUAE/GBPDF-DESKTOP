 ...
 * @author Win7
 */
@WebServlet(urlPatterns = {"/MapingLiveClass"})
public class MapingLiveClass extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet MapingLiveClass</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet MapingLiveClass at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        } finally {
            out.close();
